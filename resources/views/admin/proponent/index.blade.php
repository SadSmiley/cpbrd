...
<p>{!! link_to_route('admin.proponent.create', 'Add new', null, array('class' => 'btn btn-success')) !!}</p>
...
@if ($proponent->count())
    <div class="portlet box green">
        ...
        <div class="portlet-body">
            ...
            {!! Form::open(['route' => 'admin.proponent.massDelete', 'method' => 'post', 'id' => 'massDelete']) !!}
