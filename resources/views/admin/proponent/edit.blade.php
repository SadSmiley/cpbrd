...
<div class="form-group">
    {!! Form::label('proponent_alias', 'Proponent Name*', array('class'=>'col-md-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('proponent_alias', old('proponent_alias',$proponent->proponent_alias), array('class'=>'form-control')) !!}
    </div>
</div>
